...
namespace Gosu
{
    //! An instance of a Audio playing. Can be used to stop sounds dynamically,
    ...
    public:
        //! Called internally by Audio, do not use.
        AudioStream(int handle, int extra);
    ...
    public:
        ...
        //! normal playback speed.
        AudioStream play(double volume = 1, double speed = 1, bool looping = false) const;
        ...
        AudioStream play_pan(double pan, double volume = 1, double speed = 1,
